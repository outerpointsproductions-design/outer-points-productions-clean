...
function Header(){return <header className="nav"><a className="brand" href="#top"><img src={img('opp-12.png')}/><span>Outer Points Productions</span></a><nav><a href="#series">Series</a><a href="#badger-ko-signup">Badger KO Signup</a><a href="https://signup.outerpointsproductions.com" target="_blank">Badger KO Signup</a><a href="#champions">Champions</a><a href="#sponsors">Sponsors</a><a href="#media">Media</a><a href="#contact">Contact</a></nav></header>}
function SectionTitle({eyebrow,title,children}){return <div className="sectionTitle"><p>{eyebrow}</p><h2>{title}</h2>{children&&<div className="sectionCopy">{children}</div>}</div>}
