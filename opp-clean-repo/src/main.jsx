...
function Header(){return <header className="nav"><a className="brand" href="#top"><img src={img('opp-12.png')}/><span>Outer Points Productions</span></a><nav><a href="#series">Series</a><a href="#badger-ko-signup">Badger KO Signup</a><a href="https://signup.outerpointsproductions.com" target="_blank">Badger KO Signup</a><a href="#champions">Champions</a><a href="#sponsors">Sponsors</a><a href="#media">Media</a><a href={link || '#contact'} target={link?.startsWith('http') ? '_blank' : undefined}>
