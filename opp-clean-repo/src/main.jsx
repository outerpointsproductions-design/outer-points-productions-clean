...
const img=(n)=>A+n;
const sponsors=[
['JB Cases','3d-sponsor-logos-7-1-1.png','https://jbcases.com'] ,['American Family Insurance','amfam-1.png','https://www.amfam.com'],['Avenue Auto','avenue-auto.png','https://www.avenueautoofoshkosh.com'],['Brave Billiards','brave-1.png','https://www.brave-billiards.com'],['BridgeMates','bridgemates-1.png'],['Conscious Carnivore','conscious-1.png','https://conscious-carnivore.com'],['DKM Carpentry','dkm-1.png'],['Dumper Dan’s','dumper-1.png'],['El Poblano','el-pablano-1.png'],['Home Sweet Home','home-sweet-home-1.png'],['Johnko Express','johnko-1.png'],['LK Painting & Staining','lk-1.png'],['Midstate Amusement Games','midstate-1.png','https://midstateamusements.com'],['J. Pechauer Custom Cues','pechauer.png'],['Sorce Martial Arts','sorce.png'],['Strong Knife Company','strong.png'],['The Corner Pocket','the-corner-pocket.png'],['Tovar Construction','tovar.png'],['The Varsity Club','varsity-3.png'],['Vince D Tattoos','vincent.png'],['WIBHOF','wibhof-5.png','https://wibhof.org'],['WPPS','wpps.png'],['Onboard Sportswear','onboard-logo-2.png','https://onboardsportswear.com']
];
const eventCards=[
